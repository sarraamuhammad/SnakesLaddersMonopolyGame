...
public:
	...
	virtual void setPosition(CellPosition pos);                                     // (The effect depends on the GameObject type, so virtual)
	...
	virtual void Save(ofstream &OutFile,objecttype gameobject) = 0;	// Saves the GameObject parameters to the file
